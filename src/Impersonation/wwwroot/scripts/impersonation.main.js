...
`}renderStepValues(){return this.hideStepValues?w:l`<div id="step-values">
    ...
    `}async getMemberItems(r){if(r===""){this.items=[],this.requestUpdate("items");return}let o=await fetch("umbraco/management/api/v1/item/member/search?query="+encodeURIComponent(r),{headers:{Authorization:"Bearer "+this.userAuth.access_token}});if(!o.ok)console.error("There was a problem with the fetch operation:",await o.text());else{let i=await o.json();i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),i.items.push(i.items[0]),this.items=i.items,this.requestUpdate("items")}}onInputChange(r){clearTimeout(this.inputTimeout);let o="",i=r.target;if(i&&typeof i.value=="string")o=i.value;else if(r.composedPath){let s=r.composedPath()[0].value;typeof s=="string"&&(o=s)}this.inputTimeout=window.setTimeout(()=>{this.getMemberItems(o)},200)}};yo.styles=[c`
