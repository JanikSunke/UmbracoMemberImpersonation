...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "PackageStarter")]
    public class PackageStarterApiController : PackageStarterApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public PackageStarterApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
